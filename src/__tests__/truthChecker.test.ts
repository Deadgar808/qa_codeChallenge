describe("checking for truth", () => {
  test("are the littleNumbers < bigNumbers?", () => {
    ...
    let littleNumbers: Array<number> = [1, 3, 5];
    let bigNumbers: Array<number> = [6, 8, 10];
  ...
  test("there is a sequence to this test", () => {
    let values: Array<any> = ["bob", true, 5, null]; // set values here - the array will take any type or combo of types.
